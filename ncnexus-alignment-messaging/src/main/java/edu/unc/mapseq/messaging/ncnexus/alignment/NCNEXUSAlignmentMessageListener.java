...
public class NCNEXUSAlignmentMessageListener extends AbstractSequencingMessageListener {

    private static final Logger logger = LoggerFactory.getLogger(NCNEXUSAlignmentMessageListener.class);

    public NCNEXUSAlignmentMessageListener() {
        super();
    }
