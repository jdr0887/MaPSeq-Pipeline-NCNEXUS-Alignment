...
import edu.unc.mapseq.workflow.ncnexus.alignment.NCNEXUSAlignmentWorkflow;

public class NCNEXUSAlignmentWorkflowExecutorTask extends TimerTask {

    private static final Logger logger = LoggerFactory.getLogger(NCNEXUSAlignmentWorkflowExecutorTask.class);
    ...
    public NCNEXUSAlignmentWorkflowExecutorTask() {
        super();
    }
        ...
        try {
            ...
            if (CollectionUtils.isNotEmpty(attempts)) {
                ...
                for (WorkflowRunAttempt attempt : attempts) {
                    ...
                    NCNEXUSAlignmentWorkflow alignmentWorkflow = new NCNEXUSAlignmentWorkflow();
