package edu.unc.mapseq.commands.ncnexus.alignment;
...
@Command(scope = "ncnexus-alignment", name = "save-collect-hs-metrics-attributes", description = "Save CollectHsMetrics Attributes")
@Service
