package edu.unc.mapseq.ws.ncnexus.alignment.impl;
...
import edu.unc.mapseq.ws.ncnexus.alignment.NCNEXUSAlignmentService;
import edu.unc.mapseq.ws.ncnexus.alignment.QualityControlInfo;

public class NCNEXUSAlignmentServiceImpl implements NCNEXUSAlignmentService {

    private static final Logger logger = LoggerFactory.getLogger(NCNEXUSAlignmentServiceImpl.class);
